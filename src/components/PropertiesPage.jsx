...
const PropertiesPage = () => {
  ...
  useEffect(() => {
    const fetchProperties = async () => {
      ...
      if (!supabaseUrl || !supabaseKey || supabaseUrl === 'your_supabase_project_url' || supabaseUrl.includes('your-project')) {
          ...
          {isLoading ? (
            ...
            <div className="text-center py-20">
              <div className="w-24 h-24 mx-auto mb-6 bg-amber-100 rounded-full flex items-center justify-center">
                <i className="fa-solid fa-exclamation-triangle text-4xl text-amber-500"></i>
              </div>
