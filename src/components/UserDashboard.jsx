        ...
        {activeTab === 'messages' && (
          <div className="bg-white rounded-2xl shadow-sm overflow-hidden" style={{ height: 'calc(100vh - 280px)', minHeight: '500px' }}>
            <div className="grid grid-cols-1 md:grid-cols-3 h-full">
                ...
                <div className="flex-1 overflow-y-auto">
                  {loading ? (
                    ...
                    <div className="p-8 text-center">
                      ...
                      <p className="text-slate-600">Sem conversas</p>
                      <p className="text-sm text-slate-400 mt-1">
                        Contacte um vendedor para iniciar uma conversa
                      </p>
                    </div>
                  ) : (
                    conversations.map(conv => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {conv.unread_count > 0 && (
                            <span className="inline-flex items-center justify-center w-5 h-5 bg-emerald-500 text-white text-xs font-bold rounded-full mt-1">
                              {conv.unread_count}
                            </span>
                          )}
                        </div>
              ...
              {/* Chat Area */}
              <div className={`col-span-2 flex flex-col ${selectedConversation ? 'flex' : 'hidden md:flex'}`}>
                  ...
                  <>
                    ...
                    <div className="p-4 border-b border-gray-200 flex items-center gap-3">
                      <button
                        ...
                        className="md:hidden w-10 h-10 flex items-center justify-center text-slate-600 hover:bg-gray-100 rounded-lg"
                      >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-emerald-600">TRATA Imobiliária</p>
                      </div>
                      <a
                        href={`#imovel/${selectedConversation.property_id}`}
                        className="hidden sm:flex items-center gap-2 px-3 py-1.5 bg-gray-100 text-slate-600 rounded-lg hover:bg-gray-200 text-sm"
                      >
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50">
                      {messages.map(msg => (
                        ...
                        >
                          <div className={`max-w-[80%] ${msg.sender_type === 'user' ? 'order-2' : ''}`}>
                            {msg.sender_type !== 'user' && (
                              <p className="text-xs text-slate-500 mb-1 ml-1">
                                {msg.sender_name || 'TRATA'}
                              </p>
                            )}
                            ...
                            <p className={`text-xs text-slate-400 mt-1 ${
                              msg.sender_type === 'user' ? 'text-right mr-1' : 'ml-1'
                            }`}>
                    ...
                    <div className="p-4 border-t border-gray-200 bg-white">
                      <div className="flex gap-3">
                        ...
                        <button
                          ...
                          className="px-5 py-3 bg-emerald-500 text-white rounded-xl hover:bg-emerald-600 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors"
                        >
                  ...
                  <div className="flex-1 flex items-center justify-center bg-gray-50">
                    <div className="text-center">
                      <div className="w-20 h-20 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i className="fa-regular fa-comment-dots text-gray-400 text-3xl"></i>
                      </div>
                      <p className="text-slate-600">Selecione uma conversa</p>
                      <p className="text-sm text-slate-400 mt-1">
