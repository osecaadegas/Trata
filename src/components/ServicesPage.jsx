    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="relative bg-slate-900 py-20 lg:py-32 overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-gradient-to-br from-emerald-900/30 via-slate-900 to-slate-900"></div>
          <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-emerald-500 rounded-full filter blur-[150px] opacity-20"></div>
          <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-teal-500 rounded-full filter blur-[120px] opacity-15"></div>
        </div>
        
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-500/20 text-emerald-400 text-sm font-medium rounded-full mb-8 backdrop-blur-sm border border-emerald-500/20">
              <i className="fa-solid fa-sparkles"></i>
              Serviços Premium de Mediação Imobiliária
            </span>
            ...
            <p className="text-lg md:text-xl text-gray-300 mb-10 leading-relaxed max-w-2xl mx-auto">
              Da avaliação à escritura, oferecemos um serviço completo e personalizado 
              para garantir a melhor experiência na venda, compra ou arrendamento do seu imóvel.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                href="#contactos"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-semibold rounded-xl shadow-lg shadow-emerald-500/30 hover:shadow-xl hover:shadow-emerald-500/40 transition-all duration-300 group"
              >
